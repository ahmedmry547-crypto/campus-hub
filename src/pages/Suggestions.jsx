        ...
        <div className="bg-white dark:bg-gray-800 rounded-card p-5 shadow-sm border border-ink-50 dark:border-gray-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <textarea
              ...
              className="w-full rounded-xl bg-parchment-dim dark:bg-gray-700 text-ink-800 dark:text-white px-4 py-3 text-sm focus:outline-none resize-none"
            />
            <button
              disabled={status === 'sending'}
              className="mx-auto block w-auto px-8 bg-ink-700 text-parchment font-semibold py-2 text-sm rounded-xl disabled:opacity-60"
            >
